...
# ==========================================================================================
"""  Store common process settings, settings and other variables."""
...
class Config(object):
    ...
    def __init__(self, collection='default', overwrite=False, init=CONFIG_DICT):

        self.overwrite = overwrite
        self.container = init

        if collection not in CONFIG_DICT:
...
class Bunch(object):
    ...
    def __init__(self, collection='default', overwrite=False, init=BUNCH_DICT):
